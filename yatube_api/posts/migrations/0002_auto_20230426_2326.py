# Generated by Django 3.2.16 on 2023-04-26 20:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.CheckConstraint(check=models.Q(('following', django.db.models.expressions.F('user')), _negated=True), name='cannot subscribe to yourself'),
        ),
        migrations.AddConstraint(
            model_name='follow',
